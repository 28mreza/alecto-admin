...
/**
 * Aspect Ratio page (`/components/aspect-ratio`).
 *
 * Mirrors https://spartan.ng/components/aspect-ratio: landscape, square and
 * portrait ratios using local public/ images.
 */
@Component({
